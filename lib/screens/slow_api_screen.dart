  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Marquee(
        ...
        velocity: 40,
        text:
            "                                                                                           This is not a bug! We didn't put a loading bar, we didn't think you'll be using the app while passing through tunnels. That 250ms API call now takes 10 seconds :) Next screen could appear any moment now...",
      ),
    );
  }
}
